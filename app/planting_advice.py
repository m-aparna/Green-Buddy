# Class and methods related to check bad weather, generate alerts and generating planting advice.
class PlantingAdvice:
    ...
    # Method to check for bad weather conditions in the processed forecast based on some keywords as per response
    # returned
    ...
    # Method to generate exceptions and provide planting advice. Calls functions _generate_advice_for_day to generate advice based on forecast
    ...
    # Method to generate planting advice based on  temperature and humidity conditions
